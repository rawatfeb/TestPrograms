...
public class SshClientTest extends AbstractFactoryManager implements ClientFactoryManager {
     ...
     */
    public static SshClientTest setUpDefaultClient() {
        SshClientTest client = new SshClientTest();
    ...
    private static void setUpDefaultCiphers(SshClientTest client) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SshClientTest client = SshClientTest.setUpDefaultClient();
        client.start();
